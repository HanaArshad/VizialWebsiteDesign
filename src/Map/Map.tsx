  ...
  return (
    <div>
      ...
      >
        <h3>Legend</h3>
        <ul>
          <li style={{ color: 'red' }}>Level 3</li>
          <li style={{ color: 'yellow' }}>Level 2</li>
          <li style={{ color: 'green' }}>Level 1</li>
          <li style={{ color: 'grey' }}>Level 0</li>
          <li style={{ color: 'black' }}>No Data</li>
        </ul>
      </div>
    </div>
  );    
